...
<div class="ppm-help-main">
	...
	<p><?php esc_html_e( 'It is easy to get started with the WPassword. Simply enable and configure the password policies you want to enforce. Below are a few links of guides to help you get started:', 'ppm-wpp' ); ?></p>
	<ul>
		<li><?php echo wp_sprintf( '<a href="%1$s" target="_blank">%2$s</a>', esc_url( 'https://www.wpwhitesecurity.com/support/kb/getting-started-wpassword/?utm_source=plugin&utm_medium=referral&utm_campaign=PPMWP&utm_content=help+page' ), esc_html__( 'Getting started with the WPassword', 'ppm-wp' ) ); ?></li>
	...
	<p><?php esc_html_e( 'For more technical information about the WPassword plugin please visit the plugin’s knowledge base.', 'ppm-wp' ); ?></p>
	<div class="btn">
	...
	<p><?php esc_html_e( 'Have you encountered or noticed any issues while using the WPassword plugin? Or do you want to report something to us?', 'ppm-wp' ); ?></p>
	<div class="btn">
