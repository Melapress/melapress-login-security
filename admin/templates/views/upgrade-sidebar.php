...
<div class="upgrade-sidebar postbox-container">
    <div class="postbox">
        <h3 class="hndle" style="text-align: center;">
            ...
            <span style="display: block">Upgrade to Premium and benefit from the below features</span>
        </h3>
        <div class="inside">
            <div>
                ...
                <p style="text-align: center; margin: auto"><a class="premium-link" href="https://www.melapress.com/wordpress-login-security/pricing/?utm_source=plugins&utm_medium=link&utm_campaign=mls" target="_blank">Upgrade to Premium</a>
            </div>
        </div>
    </div>
</div>