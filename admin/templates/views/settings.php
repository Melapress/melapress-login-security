	...
	<form method="post" id="ppm-wp-settings">
		<div class="ppm-settings">
			...
			<div class="nav-tab-wrapper">
				...
				<a href="#email-settings" class="nav-tab" data-tab-target=".ppm-email-settings">Email settings</a>
				<a href="#forms-and-placement-settings" class="nav-tab" data-tab-target=".ppm-forms-and-placement-settings">Forms & Placement</a>
			</div>
			...
			<div class="settings-tab ppm-email-settings">
				<table class="form-table">
					<tbody>
						<?php echo PPM_Email_Settings::render_email_template_settings(); ?>
					</tbody>
				</table>
			</div>
			...
			<div class="settings-tab ppm-forms-and-placement-settings">
				<br>
				<?php _e( 'Use the below checkboxes to add the password policy checks on specific forms on your website.', 'ppm-wp' ) ?>
				<table class="form-table">
					<tbody>
						<tr valign="top">
							<th scope="row">
								<label for="ppm-enable_wc_pw_reset">
									<?php _e( 'WooCommerce', 'ppm-wp' ); ?>
								</label>
							</th>
							<td>
								<fieldset>
									<label for="ppm-enable_wc_pw_reset">
										<input name="_ppm_options[enable_wc_pw_reset]" type="checkbox" id="ppm-enable_wc_pw_reset"
												value="yes" <?php checked( \PPMWP\Helpers\OptionsHelper::string_to_bool( $this->options->ppm_setting->enable_wc_pw_reset ) ); ?>/>
												<?php _e( 'WooCommerce password reset page', 'ppm-wp' ) ?>
									</label>
								</fieldset>
							</td>
						</tr>
								...
								<fieldset>
									<label for="ppm-enable_ld_register">
										<input name="_ppm_options[enable_ld_register]" type="checkbox" id="ppm-enable_ld_register"
												value="yes" <?php checked( \PPMWP\Helpers\OptionsHelper::string_to_bool( $this->options->ppm_setting->enable_ld_register ) ); ?>/>
												<?php _e( 'LearnDash User register page', 'ppm-wp' ) ?>
									</label>
								</fieldset>
							</td>
						</tr>
								...
								<fieldset>
									<label for="ppm-enable_um_register">
										<input name="_ppm_options[enable_um_register]" type="checkbox" id="ppm-enable_um_register"
												value="yes" <?php checked( \PPMWP\Helpers\OptionsHelper::string_to_bool( $this->options->ppm_setting->enable_um_register ) ); ?>/>
												<?php _e( 'Ultimate Member user signup form', 'ppm-wp' ) ?>
									</label>
								</fieldset>
								<fieldset>
									<label for="ppm-enable_um_pw_update">
										<input name="_ppm_options[enable_um_pw_update]" type="checkbox" id="ppm-enable_um_pw_update"
												value="yes" <?php checked( \PPMWP\Helpers\OptionsHelper::string_to_bool( $this->options->ppm_setting->enable_um_pw_update ) ); ?>/>
												<?php _e( 'Ultimate Member password update form.', 'ppm-wp' ) ?>
									</label>
								</fieldset>
							</td>
								</tr>
								...
								<fieldset>
									<label for="ppm-enable_bp_register">
										<input name="_ppm_options[enable_bp_register]" type="checkbox" id="ppm-enable_bp_register"
												value="yes" <?php checked( \PPMWP\Helpers\OptionsHelper::string_to_bool( $this->options->ppm_setting->enable_bp_register ) ); ?>/>
												<?php _e( 'BuddyPress user signup form', 'ppm-wp' ) ?>
									</label>
								</fieldset>
								<fieldset>
									<label for="ppm-enable_bp_pw_update">
										<input name="_ppm_options[enable_bp_pw_update]" type="checkbox" id="ppm-enable_bp_pw_update"
												value="yes" <?php checked( \PPMWP\Helpers\OptionsHelper::string_to_bool( $this->options->ppm_setting->enable_bp_pw_update ) ); ?>/>
												<?php _e( 'BuddyPress password update form.', 'ppm-wp' ) ?>
									</label>
								</fieldset>
							</td>
						</tr>
								...
								<fieldset>
									<label for="ppm-enable_bbpress_pw_updater">
										<input name="_ppm_options[enable_bbpress_pw_update]" type="checkbox" id="ppm-enable_bbpress_pw_update"
												value="yes" <?php checked( \PPMWP\Helpers\OptionsHelper::string_to_bool( $this->options->ppm_setting->enable_bbpress_pw_update ) ); ?>/>
												<?php _e( 'LearnDash User register page', 'ppm-wp' ) ?>
									</label>
								</fieldset>
							</td>
