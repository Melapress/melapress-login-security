...
if ( ! class_exists( 'PPM_MB_String_Helper' ) ) {
	...
	class PPM_MB_String_Helper {
		...
		public static function mbStrShuffle( $string ) {
			$chars = self::mbGetChars( $string );
			shuffle( $chars );

			return implode( '', $chars );
		}

		private static function mbGetChars( $string ) {
			$chars = [];
		 ...
		 */
	  public static function mbSplitString( $string, $split_length = 1, $encoding = null ) {
