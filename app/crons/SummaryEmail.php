...
class SummaryEmail implements CronInterface {
	...
	public function register() {
		...
		if ( $enable_weekly_email ) {
			...
			$this->action();
		} else if ( wp_next_scheduled( 'ppmwp_send_summary_email' ) ) {
	...
	public function send_summary_email() {
		...
		$weeknumber = date( 'W' , strtotime( current_time( 'timestamp' ) ) );
	...
	public function get_users_with_recent_password_resets() {
		...
		$select = '
			...
			WHERE ' . $wpdb->usermeta . '.meta_key LIKE \'ppmwp_password_history%\'
		';
		...
		$possible_users = ( ! empty( $users ) ) ? $users : [];
