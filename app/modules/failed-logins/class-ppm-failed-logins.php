					...
					<td>
						<fieldset>
							...
							<span style="display: inline-table;">
								...
								<label for="timed"><?php _e( 'unlock it after', 'ppm-wp' ); ?> <input type="number" id="ppm-failed-login-reset-hours" name="_ppm_options[failed_login_reset_hours]" value="<?php echo esc_attr( $settings_tab->failed_login_reset_hours ) ?>" size="4" class="tiny-text ltr" min="1" required> <?php _e( 'hour(s)', 'ppm-wp' ); ?></label>
							</span>
						</fieldset>
					</td>
				</tr>
