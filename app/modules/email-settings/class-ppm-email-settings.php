...
if ( ! class_exists( 'PPM_Email_Settings' ) ) {
	...
	class PPM_Email_Settings {
		...
		public function init() {
			add_filter( 'ppmwp-settings-page-nav-tabs', array( $this, 'settings_tab_link' ), 10, 1 );
			add_filter( 'ppmwp-settings-page-content-tabs', array( $this, 'settings_tab' ), 10, 1 );
		}
		...
		public function settings_tab_link( $markup ) {
			return $markup . '<a href="#email-settings" class="nav-tab" data-tab-target=".ppm-email-settings"' . esc_attr__( '>Email settings', 'ppm-wp' ) . '</a>';
		}
			...
			?>
				...
				<div style="position: fixed; left: 980px; width: 260px; border-left: 1px solid #c3c4c7; padding: 20px;">
					...
					<p class="description"><?php esc_html_e( 'The following tags are available for use in all email template fields.', 'ppm-wp' ); ?><br><br>
						...
						{admin_email} <i><?php esc_html_e( '- Site Admin Email', 'ppm-wp' ); ?></i><br>
